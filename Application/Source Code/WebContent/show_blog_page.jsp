...
int poId=Integer.parseInt(request.getParameter("pid"));

PostDao dd=new PostDao(ConnectionProvider.getConnection());
Post post=dd.getPostBtPostId(poId);
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="profile.jsp"><span class="fa fa-bell-o"></span>Learn Code With Durgesh</a>
        </li>
...
<h4 class="text-center post-title"><%=post.getpTitle() %></h4>
</div>

<div class="card-body">

<img class="card-img-top my-2" src="image/<%=post.getpPic() %>" alt="Card image cap" >
	...
	%>
	<p class="post-user-info"> <a class="user-anchor" href="#!"><%=d.getUserByUserId(post.getUserId()).getName() %></a> has Posted : </p>
	</div>
	<div class="col-md-4">
...
<div class="card-footer primary-background text-white">
	...
	<a href="#!" onclick="doLike(<%=post.getPid() %>,<%=user.getId() %>)" class="btn btn-outline-light btn-sm"><i class="bi bi-hand-thumbs-up"></i><span>20</span></a>
	  ...
	  <div class="modal-dialog">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        ...
	        PostDao pt=new PostDao(ConnectionProvider.getConnection());
	        
	        ArrayList<Category> list=pt.getAllCategories();
